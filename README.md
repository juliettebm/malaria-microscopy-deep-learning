...
- **Transfer learning limité à un backbone gelé** : aucun fine-tuning (partiel ou complet) n'a été testé, et l'effet des BatchNorm gelées n'a pas été isolé par une ablation dédiée.
- **Règle patient réglée sur 30 patients de validation** : elle n'a pas été évaluée par validation croisée groupée par patient, et aucune évaluation au niveau lame n'a été faite.
